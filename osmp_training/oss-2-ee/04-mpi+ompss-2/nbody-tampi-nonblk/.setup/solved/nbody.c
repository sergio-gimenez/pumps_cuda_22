...
static void recv_particles_block(particles_block_t *sendbuf, int block_id, int src);
...
#pragma oss task label("send_particles_block") in(*sendbuf)
...
#pragma oss task label("recv_particles_block") out(*recvbuf)
